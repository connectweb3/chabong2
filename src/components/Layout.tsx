...
export const Layout = () => {
    ...
    const navItems = [
        ...
        { name: 'Bet History', icon: History, path: '/transactions' },
        { name: 'Wallet', icon: Wallet, path: '/credits' },
            ...
            <header className="h-16 bg-casino-dark-900/50 backdrop-blur-md border-b border-white/5 flex items-center px-4 md:px-6 justify-between sticky top-0 z-40">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <div className="flex flex-col items-end">
                        <span className="text-[10px] text-casino-slate-500 font-bold uppercase tracking-wider">Credits</span>
                        <div className="flex items-center gap-2">
                            <span className="text-casino-gold-400 font-black">₱</span>
                            <span className="text-lg font-display font-bold text-white leading-none">
                                {profile.credits?.toLocaleString() ?? '0.00'}
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-3 md:hidden">
                    <div className="text-right">
                        <div className="text-[10px] text-casino-gold-400 font-bold">₱ {profile.credits?.toLocaleString() ?? '0.00'}</div>
                    </div>
